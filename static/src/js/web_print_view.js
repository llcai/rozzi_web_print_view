odoo.define('web_print_view.web_print_view', function(require) {
    ...
    ListView.include({
        ...
        on_export_table: function () {
            ...
            export_columns_names[0]=export_columns_names[0].replace(_t('Export'),'').trim();
    ...
    Sidebar.include({
        ...
        redraw: function () {
            ...
            else
            {
                ...
                $('.oe_sidebar_expand_group').css({"display":"none"});
                $('.oe_sidebar_collapse_group').css({"display":"none"});
